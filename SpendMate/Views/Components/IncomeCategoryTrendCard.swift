...
struct IncomeCategoryTrendCard: View {
    let trends: [(category: IncomeCategory, trend: Trend)]
...
#Preview("Light Mode") {
    IncomeCategoryTrendCard(
        trends: [
            (IncomeCategory.salary, Trend(isIncreasing: true, percentage: 15.5, change: 1500)),
            (IncomeCategory.investment, Trend(isIncreasing: false, percentage: 8.3, change: -500))
        ]
    )
    .padding()
}
